...
function valManager(){
	//alert("hello");
	 if(document.batchForm.adminRole.value=="" || document.batchForm.adminRole.value=="temp")
    {
        alert("Admin Role cannot be null");
        document.batchForm.adminRole.focus(); 
       }else  if(document.batchForm.adminUserName.value=="" )
       {
           alert("Admin Email cannot be null");
           document.batchForm.adminUserName.focus(); 
          }
	else {
		$(function(){
			//alert("in cp func");
...
<input type="hidden" name="manDiffer" value="def">
</form>
<input type="button" value="create" onclick="valManager()">
</div>
<div id="val"></div>
</body>
</html>