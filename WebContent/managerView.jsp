...
<div id="tabs">
  ...
  <li><a href="GetAll">All Awards Nominations</a></li>
  <li><a href="GetAllAwardsServlet">Awards Stats</a></li>      
  <li><a href="GetSubmitAssignmentServlet">Assignment Submissions</a></li>
   <li><a href="VotesResultsServlet">Poc Votes Results</a></li>
  <li><a href="manBatchUpload.jsp">Upload Batch Details</a></li>
  <li><a href="ManCreateAdmin.jsp">Create Trainer/LND</a></li>  
  <li><a href="ChangePassword2.jsp">Change Password</a></li>
  <li><a href="Meetings.jsp">Under Construction</a></li>
          </ul>
  <div id="tabs-3">
    <h2>Updates</h2>
